...
#if DOSKIT
extern void (*GFX_EventsHandler)(void);
extern Bitu (*GFX_GetBestModeHandler)(Bitu flags);
extern Bitu (*GFX_GetRGBHandler)(Bit8u red, Bit8u green, Bit8u blue);
extern Bitu (*GFX_SetSizeHandler)(Bitu width, Bitu height, Bitu flags, double scalex, double scaley, GFX_CallBack_t cb);
extern bool (*GFX_StartUpdateHandler)(Bit8u * &pixels, Bitu &pitch);
extern void (*GFX_EndUpdateHandler)(const Bit16u *changedLines);
#endif
